...
const GitHubCorner: React.FC = () => {
  const openGitHub = (event: React.MouseEvent<HTMLAnchorElement, MouseEvent>) => {
    event.preventDefault()
    window.open('https://github.com/0xsequence/wallet-recovery-app', '_blank', 'noopener,noreferrer')
  }
  ...
  return (
    <>
      ...
      <a
        href="#" // You can set this to 'javascript:void(0)' if preferred
